...
function func(data) {
  var state = data.substring(0, 2),
      code = data.substring(14, 17),
      amount = data.substring(17, 32);

  // obj.state = stateLookupTable[state];
  // obj.item = itemCodeLookupTable[code];
  // obj.amount = data.substring(17, 32);
  // obj.surveyYear = data.substring(32, 34);
  // obj.datYear = data.substring(34, 36);
  // obj.origin = data.substring(36, 38);

  // console.log(obj);
}

var stateLookupTable = {
   "01": "Alabama",
   "02": "Alaska",
   "03": "Arizona",
   "04": "Arkansas",
...
var input = fs.createReadStream('rawdata/financialdata.txt');
